...
when ODIN_OS == .Darwin {
	...
	foreign import lib "wasm/dcimgui_nodefaultargfunctions_internal.o"
} else {
...
DrawTextFlags :: bit_set[DrawTextFlag; i32]
DrawTextFlag :: enum i32 {
...
ItemStatusFlags :: bit_set[ItemStatusFlag; i32]
ItemStatusFlag :: enum i32 {
	...
	EditedInternal = 11, // Similar to ImGuiItemStatusFlags_Edited but bypassing ImGuiItemFlags_NoMarkEdited.
}


// Extend ImGuiInputTextFlags_
InputTextFlagsPrivate :: enum i32 {
	// [Internal]
...
SelectableFlagsPrivate :: enum i32 {
...
SeparatorFlags :: bit_set[SeparatorFlag; i32]
SeparatorFlag :: enum i32 {
...
FocusRequestFlags :: bit_set[FocusRequestFlag; i32]
FocusRequestFlag :: enum i32 {
...
TextFlags :: bit_set[TextFlag; i32]
TextFlag :: enum i32 {
	NoWidthForLargeClippedText = 0,
}


TooltipFlags :: bit_set[TooltipFlag; i32]
TooltipFlag :: enum i32 {
...
WindowRefreshFlags :: bit_set[WindowRefreshFlag; i32]
WindowRefreshFlag :: enum i32 {
...
WindowBgClickFlags :: bit_set[WindowBgClickFlag; i32]
WindowBgClickFlag :: enum i32 {
	Move = 0, // Click on bg/void + drag to move window. Cleared by default when using io.ConfigWindowsMoveFromTitleBarOnly.
}


NextWindowDataFlags :: bit_set[NextWindowDataFlag; i32]
NextWindowDataFlag :: enum i32 {
	HasPos            = 0,
	HasSize           = 1,
	HasContentSize    = 2,
	HasCollapsed      = 3,
...
NextItemDataFlags :: bit_set[NextItemDataFlag; i32]
NextItemDataFlag :: enum i32 {
	HasWidth       = 0,
	HasOpen        = 1,
	HasShortcut    = 2,
	HasRefVal      = 3,
...
ActivateFlags :: bit_set[ActivateFlag; i32]
ActivateFlag :: enum i32 {
...
ScrollFlags :: bit_set[ScrollFlag; i32]
ScrollFlag :: enum i32 {
...
NavRenderCursorFlags :: bit_set[NavRenderCursorFlag; i32]
NavRenderCursorFlag :: enum i32 {
...
NavMoveFlags :: bit_set[NavMoveFlag; i32]
NavMoveFlag :: enum i32 {
...
TypingSelectFlags :: distinct i32
TypingSelectFlags_None                :: TypingSelectFlags({})
...
OldColumnFlags :: bit_set[OldColumnFlag; i32]
OldColumnFlag :: enum i32 {
...
DataAuthority :: enum i32 {
	Auto,
	DockNode,
	Window,
}

DockNodeState :: enum i32 {
	Unknown,
...
LocKey :: enum i32 { // Forward declared enum type ImGuiLocKey
	VersionStr,
	TableSizeOne,
	TableSizeAllFit,
	TableSizeAllDefault,
...
DebugLogFlags :: bit_set[DebugLogFlag; i32]
DebugLogFlag :: enum i32 {
...
BoxSelectState :: struct {
	...
	UnclipRects:       [2]Rect, // Per-axis versions.
...
Context :: struct {
	...
	WithinEndPopupID:                   ID,                  // Set within EndPopup()
...
Window :: struct {
	...
	ResizeBorderHovered:                u8,                 // Current border being hovered for resize (-1: none, otherwise 0-3)
	ResizeBorderHeld:                   u8,                 // Current border being held for resize (-1: none, otherwise 0-3)
...
FontLoader :: struct {
	...
	FontBakedSrcLoaderDataSize: uint,
}
...
foreign lib {
	// Helpers: Hashing
	@(link_name="cImHashData")                     cImHashData                     :: proc(data: rawptr, data_size: uint, seed: ID = {}) -> ID      ---
	@(link_name="cImHashStr")                      cImHashStr                      :: proc(data: cstring, data_size: uint = 0, seed: ID = {}) -> ID ---
	...
	@(link_name="cImIsPowerOfTwo")      cImIsPowerOfTwo      :: proc(v: i32) -> bool                                                                            ---
	@(link_name="cImIsPowerOfTwoImU64") cImIsPowerOfTwoImU64 :: proc(v: u64) -> bool                                                                            ---
	@(link_name="cImUpperPowerOfTwo")   cImUpperPowerOfTwo   :: proc(v: i32) -> i32                                                                             ---
	@(link_name="cImCountSetBits")      cImCountSetBits      :: proc(v: u32) -> u32                                                                             ---
	@(link_name="cImStricmp")           cImStricmp           :: proc(str1: cstring, str2: cstring) -> i32                                                       --- // Case insensitive compare.
	@(link_name="cImStrnicmp")          cImStrnicmp          :: proc(str1: cstring, str2: cstring, count: uint) -> i32                                          --- // Case insensitive compare to a certain count.
	@(link_name="cImStrncpy")           cImStrncpy           :: proc(dst: cstring, src: cstring, count: uint)                                                   --- // Copy to a certain count and always zero terminate (strncpy doesn't).
	@(link_name="cImStrdup")            cImStrdup            :: proc(str: cstring) -> cstring                                                                   --- // Duplicate a string.
	@(link_name="cImMemdup")            cImMemdup            :: proc(src: rawptr, size: uint) -> rawptr                                                         --- // Duplicate a chunk of memory.
	@(link_name="cImStrdupcpy")         cImStrdupcpy         :: proc(dst: cstring, p_dst_size: ^uint, str: cstring) -> cstring                                  --- // Copy in provided buffer, recreate buffer if needed.
	@(link_name="cImStrchrRange")       cImStrchrRange       :: proc(str_begin: cstring, str_end: cstring, _c: u8) -> cstring                                   --- // Find first occurrence of 'c' in string range.
	...
	@(link_name="cImStrlenW")           cImStrlenW           :: proc(str: ^Wchar) -> i32                                                                        --- // Computer string length (ImWchar string)
	@(link_name="cImStrbol")            cImStrbol            :: proc(buf_mid_line: cstring, buf_begin: cstring) -> cstring                                      --- // Find beginning-of-line
	@(link_name="cImToUpper")           cImToUpper           :: proc(_c: u8) -> u8                                                                              ---
	@(link_name="cImCharIsBlankA")      cImCharIsBlankA      :: proc(_c: u8) -> bool                                                                            ---
	@(link_name="cImCharIsBlankW")      cImCharIsBlankW      :: proc(_c: u32) -> bool                                                                           ---
	@(link_name="cImCharIsXdigitA")     cImCharIsXdigitA     :: proc(_c: u8) -> bool                                                                            ---
	// Helpers: Formatting
	@(link_name="cImFormatString") cImFormatString :: proc(buf: cstring, buf_size: uint, fmt: cstring, #c_vararg args: ..any) -> i32 ---
	// Helpers: Formatting
	@(link_name="cImFormatStringUnformatted")             cImFormatStringUnformatted             :: proc(buf: cstring, buf_size: uint, text: cstring) -> i32                            ---
	...
	@(link_name="cImFormatStringToTempBufferUnformatted") cImFormatStringToTempBufferUnformatted :: proc(out_buf: ^cstring, out_buf_end: ^cstring, text: cstring)                       ---
	...
	@(link_name="cImParseFormatTrimDecorations")          cImParseFormatTrimDecorations          :: proc(format: cstring, buf: cstring, buf_size: uint) -> cstring                      ---
	@(link_name="cImParseFormatSanitizeForPrinting")      cImParseFormatSanitizeForPrinting      :: proc(fmt_in: cstring, fmt_out: cstring, fmt_out_size: uint)                         ---
	@(link_name="cImParseFormatSanitizeForScanning")      cImParseFormatSanitizeForScanning      :: proc(fmt_in: cstring, fmt_out: cstring, fmt_out_size: uint) -> cstring              ---
	@(link_name="cImParseFormatPrecision")                cImParseFormatPrecision                :: proc(format: cstring, default_value: i32) -> i32                                    ---
	// Helpers: UTF-8 <> wchar conversions
	@(link_name="cImTextCharToUtf8")                    cImTextCharToUtf8                    :: proc(out_buf: ^[5]u8, _c: u32) -> i32                                                                                                                                                                      --- // return output UTF-8 bytes count
	@(link_name="cImTextStrToUtf8")                     cImTextStrToUtf8                     :: proc(out_buf: cstring, out_buf_size: i32, in_text: ^Wchar, in_text_end: ^Wchar) -> i32                                                                                                                     --- // return output UTF-8 bytes count
	@(link_name="cImTextCharFromUtf8")                  cImTextCharFromUtf8                  :: proc(out_char: ^u32, in_text: cstring, in_text_end: cstring) -> i32                                                                                                                                        --- // read one character. return input UTF-8 bytes count
	@(link_name="cImTextStrFromUtf8")                   cImTextStrFromUtf8                   :: proc(out_buf: ^Wchar, out_buf_size: i32, in_text: cstring, in_text_end: cstring, in_remaining: ^cstring = nil) -> i32                                                                                      --- // return input UTF-8 bytes count
	@(link_name="cImTextCountCharsFromUtf8")            cImTextCountCharsFromUtf8            :: proc(in_text: cstring, in_text_end: cstring) -> i32                                                                                                                                                        --- // return number of UTF-8 code-points (NOT bytes count)
	@(link_name="cImTextCountUtf8BytesFromChar")        cImTextCountUtf8BytesFromChar        :: proc(in_text: cstring, in_text_end: cstring) -> i32                                                                                                                                                        --- // return number of bytes to express one char in UTF-8
	@(link_name="cImTextCountUtf8BytesFromStr")         cImTextCountUtf8BytesFromStr         :: proc(in_text: ^Wchar, in_text_end: ^Wchar) -> i32                                                                                                                                                          --- // return number of bytes to express string in UTF-8
	...
	@(link_name="cImTextCountLines")                    cImTextCountLines                    :: proc(in_text: cstring, in_text_end: cstring) -> i32                                                                                                                                                        --- // return number of lines taken by text. trailing carriage return doesn't count as an extra line.
	...
	@(link_name="cImTextClassifierClear")               cImTextClassifierClear               :: proc(bits: ^u32, codepoint_min: u32, codepoint_end: u32, char_class: WcharClass)                                                                                                                           ---
	@(link_name="cImTextClassifierSetCharClass")        cImTextClassifierSetCharClass        :: proc(bits: ^u32, codepoint_min: u32, codepoint_end: u32, char_class: WcharClass, _c: u32)                                                                                                                  ---
	@(link_name="cImTextClassifierSetCharClassFromStr") cImTextClassifierSetCharClassFromStr :: proc(bits: ^u32, codepoint_min: u32, codepoint_end: u32, char_class: WcharClass, s: cstring)                                                                                                               ---
	...
	@(link_name="cImFileLoadToMemory")                  cImFileLoadToMemory                  :: proc(filename: cstring, mode: cstring, out_file_size: ^uint = nil, padding_bytes: i32 = 0) -> rawptr                                                                                                       ---
	...
	@(link_name="cImAbs")                               cImAbs                               :: proc(x: i32) -> i32                                                                                                                                                                                        ---
	...
	@(link_name="cImRsqrtFloat")                        cImRsqrtFloat                        :: proc(x: f32) -> f32                                                                                                                                                                                        ---
	...
	@(link_name="cImModPositive")                            cImModPositive                            :: proc(a: i32, b: i32) -> i32                             ---
	...
	@(link_name="cImExponentialMovingAverage")               cImExponentialMovingAverage               :: proc(avg: f32, sample: f32, n: i32) -> f32              ---
	// Helpers: Geometry
	@(link_name="cImBezierCubicCalc")                    cImBezierCubicCalc                  :: proc(p1: Vec2, p2: Vec2, p3: Vec2, p4: Vec2, t: f32) -> Vec2                     ---
	@(link_name="cImBezierCubicClosestPoint")            cImBezierCubicClosestPoint          :: proc(p1: Vec2, p2: Vec2, p3: Vec2, p4: Vec2, p: Vec2, num_segments: i32) -> Vec2 --- // For curves with explicit number of segments
	...
	@(link_name="ImRect_AddX")                           Rect_AddX                           :: proc(self: ^Rect, x: f32)                                                        ---
	@(link_name="ImRect_AddY")                           Rect_AddY                           :: proc(self: ^Rect, y: f32)                                                        ---
	...
	@(link_name="cImBitArrayGetStorageSizeInBytes")      cImBitArrayGetStorageSizeInBytes    :: proc(bitcount: i32) -> uint                                                      ---
	@(link_name="cImBitArrayClearAllBits")               cImBitArrayClearAllBits             :: proc(arr: ^u32, bitcount: i32)                                                   ---
	@(link_name="cImBitArrayTestBit")                    cImBitArrayTestBit                  :: proc(arr: ^u32, n: i32) -> bool                                                  ---
	@(link_name="cImBitArrayClearBit")                   cImBitArrayClearBit                 :: proc(arr: ^u32, n: i32)                                                          ---
	@(link_name="cImBitArraySetBit")                     cImBitArraySetBit                   :: proc(arr: ^u32, n: i32)                                                          ---
	@(link_name="cImBitArraySetBitRange")                cImBitArraySetBitRange              :: proc(arr: ^u32, n: i32, n2: i32)                                                 --- // Works on range [n..n2)
	@(link_name="ImBitVector_Create")                    BitVector_Create                    :: proc(self: ^BitVector, sz: i32)                                                  ---
	@(link_name="ImBitVector_Clear")                     BitVector_Clear                     :: proc(self: ^BitVector)                                                           ---
	@(link_name="ImBitVector_TestBit")                   BitVector_TestBit                   :: proc(self: ^BitVector, n: i32) -> bool                                           ---
	@(link_name="ImBitVector_SetBit")                    BitVector_SetBit                    :: proc(self: ^BitVector, n: i32)                                                   ---
	@(link_name="ImBitVector_ClearBit")                  BitVector_ClearBit                  :: proc(self: ^BitVector, n: i32)                                                   ---
	@(link_name="ImStableVector_ImFontBaked_32_clear")   StableVector_ImFontBaked_32_clear   :: proc(self: ^StableVector_ImFontBaked_32)                                         ---
	@(link_name="ImStableVector_ImFontBaked_32_resize")  StableVector_ImFontBaked_32_resize  :: proc(self: ^StableVector_ImFontBaked_32, new_size: i32)                          ---
	@(link_name="ImStableVector_ImFontBaked_32_reserve") StableVector_ImFontBaked_32_reserve :: proc(self: ^StableVector_ImFontBaked_32, new_cap: i32)                           ---
	@(link_name="ImGuiTextIndex_clear")                  TextIndex_clear                     :: proc(self: ^TextIndex)                                                           ---
	@(link_name="ImGuiTextIndex_size")                   TextIndex_size                      :: proc(self: ^TextIndex) -> i32                                                    ---
	@(link_name="ImGuiTextIndex_get_line_begin")         TextIndex_get_line_begin            :: proc(self: ^TextIndex, base: cstring, n: i32) -> cstring                         ---
	@(link_name="ImGuiTextIndex_get_line_end")           TextIndex_get_line_end              :: proc(self: ^TextIndex, base: cstring, n: i32) -> cstring                         ---
	@(link_name="ImGuiTextIndex_append")                 TextIndex_append                    :: proc(self: ^TextIndex, base: cstring, old_size: i32, new_size: i32)              ---
	// Helper: ImGuiStorage
	...
	@(link_name="ImGuiInputTextState_OnKeyPressed")                   InputTextState_OnKeyPressed                      :: proc(self: ^InputTextState, key: i32)                                                    --- // Cannot be inline because we call in code in stb_textedit.h implementation
	@(link_name="ImGuiInputTextState_OnCharPressed")                  InputTextState_OnCharPressed                     :: proc(self: ^InputTextState, _c: u32)                                                     ---
	...
	@(link_name="ImGuiInputTextState_GetCursorPos")      InputTextState_GetCursorPos      :: proc(self: ^InputTextState) -> i32                ---
	@(link_name="ImGuiInputTextState_GetSelectionStart") InputTextState_GetSelectionStart :: proc(self: ^InputTextState) -> i32                ---
	@(link_name="ImGuiInputTextState_GetSelectionEnd")   InputTextState_GetSelectionEnd   :: proc(self: ^InputTextState) -> i32                ---
	@(link_name="ImGuiInputTextState_SetSelection")      InputTextState_SetSelection      :: proc(self: ^InputTextState, start: i32, end: i32) ---
	...
	@(link_name="ImGuiListClipperRange_FromIndices")                 ListClipperRange_FromIndices                 :: proc(min: i32, max: i32) -> ListClipperRange                           ---
	@(link_name="ImGuiListClipperRange_FromPositions")               ListClipperRange_FromPositions               :: proc(y1: f32, y2: f32, off_min: i32, off_max: i32) -> ListClipperRange ---
	...
	@(link_name="ImGuiWindow_GetIDInt")            Window_GetIDInt            :: proc(self: ^Window, n: i32) -> ID                               ---
	...
	@(link_name="ImGui_FindWindowDisplayIndex")                      FindWindowDisplayIndex                      :: proc(window: ^Window) -> i32                                                                                   ---
	...
	// Fonts, drawing
	@(link_name="ImGui_RegisterUserTexture")                 RegisterUserTexture                 :: proc(tex: ^TextureData)                                                         --- // Register external texture. EXPERIMENTAL.
	...
	// Localization
	@(link_name="ImGui_LocalizeRegisterEntries") LocalizeRegisterEntries :: proc(entries: ^LocEntry, count: i32) ---
	...
	@(link_name="ImGui_GetIDWithSeed")      GetIDWithSeed      :: proc(n: i32, seed: ID) -> ID                                     ---
	...
	@(link_name="ImGui_PushMultiItemsWidths")      PushMultiItemsWidths      :: proc(components: i32, width_full: f32)                                                              ---
	@(link_name="ImGui_ShrinkWidths")              ShrinkWidths              :: proc(items: ^ShrinkWidthItem, count: i32, width_excess: f32, width_min: f32)                        ---
	@(link_name="ImGui_CalcClipRectVisibleItemsY") CalcClipRectVisibleItemsY :: proc(clip_rect: Rect, pos: Vec2, items_height: f32, out_visible_start: ^i32, out_visible_end: ^i32) ---
	...
	// Logging/Capture
	@(link_name="ImGui_LogBegin")                 LogBegin                 :: proc(flags: LogFlags, auto_open_depth: i32)                  --- // -> BeginCapture() when we design v2 api, for now stay under the radar by using the old name.
	@(link_name="ImGui_LogToBuffer")              LogToBuffer              :: proc(auto_open_depth: i32 = -1)                              --- // Start logging/capturing to internal buffer
	...
	@(link_name="ImGui_FindFrontMostVisibleChildWindow") FindFrontMostVisibleChildWindow :: proc(window: ^Window) -> ^Window                                                                        ---
	// Popups, Modals
	...
	@(link_name="ImGui_ClosePopupToLevel")              ClosePopupToLevel              :: proc(remaining: i32, restore_focus_to_window_under_popup: bool)                                                    ---
	...
	@(link_name="ImGui_CalcTypematicRepeatAmount")       CalcTypematicRepeatAmount       :: proc(t0: f32, t1: f32, repeat_delay: f32, repeat_rate: f32) -> i32      ---
	...
	@(link_name="ImGui_SetItemKeyOwnerImGuiInputFlags") SetItemKeyOwnerImGuiInputFlags :: proc(key: Key, flags: InputFlags) -> bool                 ---
	...
	@(link_name="ImGui_DockNodeGetDepth")                   DockNodeGetDepth                   :: proc(node: ^DockNode) -> i32                                                                                                                               ---
	...
	@(link_name="ImGui_IsInNavFocusRoute")    IsInNavFocusRoute    :: proc(focus_scope_id: ID) -> bool ---
	...
	@(link_name="ImGui_RenderDragDropTargetRectEx")      RenderDragDropTargetRectEx      :: proc(draw_list: ^DrawList, bb: Rect, rounding: f32)  ---
	// Typing-Select API
	...
	@(link_name="ImGui_TypingSelectFindMatch")               TypingSelectFindMatch               :: proc(req: ^TypingSelectRequest, items_count: i32, get_item_name_func: proc "c" (arg_0: rawptr, arg_1: i32) -> cstring, user_data: rawptr, nav_item_idx: i32) -> i32 ---
	@(link_name="ImGui_TypingSelectFindNextSingleCharMatch") TypingSelectFindNextSingleCharMatch :: proc(req: ^TypingSelectRequest, items_count: i32, get_item_name_func: proc "c" (arg_0: rawptr, arg_1: i32) -> cstring, user_data: rawptr, nav_item_idx: i32) -> i32 ---
	@(link_name="ImGui_TypingSelectFindBestLeadingMatch")    TypingSelectFindBestLeadingMatch    :: proc(req: ^TypingSelectRequest, items_count: i32, get_item_name_func: proc "c" (arg_0: rawptr, arg_1: i32) -> cstring, user_data: rawptr) -> i32                    ---
	// Box-Select API
	...
	@(link_name="ImGui_MultiSelectAddSetRange") MultiSelectAddSetRange :: proc(ms: ^MultiSelectTempData, selected: bool, range_dir: i32, first_item: SelectionUserData, last_item: SelectionUserData) ---
	...
	@(link_name="ImGui_BeginColumns")                      BeginColumns                      :: proc(str_id: cstring, count: i32, flags: OldColumnFlags = {}) --- // setup number of columns. use an identifier to distinguish multiple column sets. close with EndColumns().
	@(link_name="ImGui_EndColumns")                        EndColumns                        :: proc()                                                        --- // close columns
	@(link_name="ImGui_PushColumnClipRect")                PushColumnClipRect                :: proc(column_index: i32)                                       ---
	...
	@(link_name="ImGui_GetColumnsID")                      GetColumnsID                      :: proc(str_id: cstring, count: i32) -> ID                       ---
	...
	@(link_name="ImGui_TableOpenContextMenu")              TableOpenContextMenu              :: proc(column_n: i32 = -1)                                                                    ---
	@(link_name="ImGui_TableSetColumnWidth")               TableSetColumnWidth               :: proc(column_n: i32, width: f32)                                                             ---
	@(link_name="ImGui_TableSetColumnSortDirection")       TableSetColumnSortDirection       :: proc(column_n: i32, sort_direction: SortDirection, append_to_sort_specs: bool)              ---
	@(link_name="ImGui_TableGetHoveredRow")                TableGetHoveredRow                :: proc() -> i32                                                                               --- // Retrieve *PREVIOUS FRAME* hovered row. This difference with TableGetHoveredColumn() is the reason why this is not public yet.
	...
	@(link_name="ImGui_TablePushColumnChannel")            TablePushColumnChannel            :: proc(column_n: i32)                                                                         ---
	@(link_name="ImGui_TablePopColumnChannel")             TablePopColumnChannel             :: proc()                                                                                      ---
	@(link_name="ImGui_TableAngledHeadersRowEx")           TableAngledHeadersRowEx           :: proc(row_id: ID, angle: f32, max_label_width: f32, data: ^TableHeaderData, data_count: i32) ---
	// Tables: Internals
	@(link_name="ImGui_GetCurrentTable")                                     GetCurrentTable                                     :: proc() -> ^Table                                                                                                                   ---
	@(link_name="ImGui_TableFindByID")                                       TableFindByID                                       :: proc(id: ID) -> ^Table                                                                                                             ---
	@(link_name="ImGui_BeginTableWithID")                                    BeginTableWithID                                    :: proc(name: cstring, id: ID, columns_count: i32, flags: TableFlags = {}, outer_size: Vec2 = {0, 0}, inner_width: f32 = 0.0) -> bool ---
	@(link_name="ImGui_TableBeginInitMemory")                                TableBeginInitMemory                                :: proc(table: ^Table, columns_count: i32)                                                                                            ---
	...
	@(link_name="ImGui_TableApplyExternalUnclipRect")                        TableApplyExternalUnclipRect                        :: proc(table: ^Table, rect: ^Rect)                                                                                                   ---
	...
	@(link_name="ImGui_TableGetInstanceData")                                TableGetInstanceData                                :: proc(table: ^Table, instance_no: i32) -> ^TableInstanceData                                                                        ---
	@(link_name="ImGui_TableGetInstanceID")                                  TableGetInstanceID                                  :: proc(table: ^Table, instance_no: i32) -> ID                                                                                        ---
	...
	@(link_name="ImGui_TableBeginCell")                                      TableBeginCell                                      :: proc(table: ^Table, column_n: i32)                                                                                                 ---
	@(link_name="ImGui_TableEndCell")                                        TableEndCell                                        :: proc(table: ^Table)                                                                                                                ---
	@(link_name="ImGui_TableGetCellBgRect")                                  TableGetCellBgRect                                  :: proc(table: ^Table, column_n: i32) -> Rect                                                                                         ---
	@(link_name="ImGui_TableGetColumnNameImGuiTablePtr")                     TableGetColumnNameImGuiTablePtr                     :: proc(table: ^Table, column_n: i32) -> cstring                                                                                      ---
	@(link_name="ImGui_TableGetColumnResizeID")                              TableGetColumnResizeID                              :: proc(table: ^Table, column_n: i32, instance_no: i32 = 0) -> ID                                                                     ---
	@(link_name="ImGui_TableCalcMaxColumnWidth")                             TableCalcMaxColumnWidth                             :: proc(table: ^Table, column_n: i32) -> f32                                                                                          ---
	@(link_name="ImGui_TableSetColumnWidthAutoSingle")                       TableSetColumnWidthAutoSingle                       :: proc(table: ^Table, column_n: i32)                                                                                                 ---
	@(link_name="ImGui_TableSetColumnWidthAutoAll")                          TableSetColumnWidthAutoAll                          :: proc(table: ^Table)                                                                                                                ---
	@(link_name="ImGui_TableSetColumnDisplayOrder")                          TableSetColumnDisplayOrder                          :: proc(table: ^Table, column_n: i32, dst_order: i32)                                                                                 ---
	@(link_name="ImGui_TableQueueSetColumnDisplayOrder")                     TableQueueSetColumnDisplayOrder                     :: proc(table: ^Table, column_n: i32, dst_order: i32)                                                                                 ---
	...
	@(link_name="ImGui_TableSettingsCreate")             TableSettingsCreate             :: proc(id: ID, columns_count: i32) -> ^TableSettings ---
	...
	@(link_name="ImGui_TabBarFindTabByOrder")                             TabBarFindTabByOrder                             :: proc(tab_bar: ^TabBar, order: i32) -> ^TabItem                                                                                                                                                              ---
	...
	@(link_name="ImGui_TabBarGetTabOrder")                                TabBarGetTabOrder                                :: proc(tab_bar: ^TabBar, tab: ^TabItem) -> i32                                                                                                                                                                ---
	...
	@(link_name="ImGui_TabBarQueueReorder")                               TabBarQueueReorder                               :: proc(tab_bar: ^TabBar, tab: ^TabItem, offset: i32)                                                                                                                                                          ---
	...
	@(link_name="ImGui_GetWindowResizeCornerID")          GetWindowResizeCornerID          :: proc(window: ^Window, n: i32) -> ID                                                                                              --- // 0..3: corners
	...
	@(link_name="ImGui_DataTypeFormatString")  DataTypeFormatString  :: proc(buf: cstring, buf_size: i32, data_type: DataType, p_data: rawptr, format: cstring) -> i32                    ---
	@(link_name="ImGui_DataTypeApplyOp")       DataTypeApplyOp       :: proc(data_type: DataType, op: i32, output: rawptr, arg_1: rawptr, arg_2: rawptr)                                  ---
	...
	@(link_name="ImGui_DataTypeCompare")       DataTypeCompare       :: proc(data_type: DataType, arg_1: rawptr, arg_2: rawptr) -> i32                                                    ---
	...
	// InputText
	@(link_name="ImGui_InputTextWithHintAndSize") InputTextWithHintAndSize :: proc(label: cstring, hint: cstring, buf: cstring, buf_size: i32, size_arg: Vec2, flags: InputTextFlags, callback: InputTextCallback = nil, user_data: rawptr = nil) -> bool ---
	@(link_name="ImGui_InputTextDeactivateHook")  InputTextDeactivateHook  :: proc(id: ID)                                                                                                                                                                ---
	@(link_name="ImGui_TempInputText")            TempInputText            :: proc(bb: Rect, id: ID, label: cstring, buf: cstring, buf_size: uint, flags: InputTextFlags = {}, callback: InputTextCallback = nil, user_data: rawptr = nil) -> bool        ---
	...
	// Plot
	@(link_name="ImGui_PlotEx") PlotEx :: proc(plot_type: PlotType, label: cstring, values_getter: proc "c" (data: rawptr, idx: i32) -> f32, data: rawptr, values_count: i32, values_offset: i32, overlay_text: cstring, scale_min: f32, scale_max: f32, size_arg: Vec2) -> i32 ---
	// Shade functions (write over already created vertices)
	@(link_name="ImGui_ShadeVertsLinearColorGradientKeepAlpha") ShadeVertsLinearColorGradientKeepAlpha :: proc(draw_list: ^DrawList, vert_start_idx: i32, vert_end_idx: i32, gradient_p0: Vec2, gradient_p1: Vec2, col0: u32, col1: u32) ---
	@(link_name="ImGui_ShadeVertsLinearUV")                     ShadeVertsLinearUV                     :: proc(draw_list: ^DrawList, vert_start_idx: i32, vert_end_idx: i32, a: Vec2, b: Vec2, uv_a: Vec2, uv_b: Vec2, clamp: bool)      ---
	@(link_name="ImGui_ShadeVertsTransformPos")                 ShadeVertsTransformPos                 :: proc(draw_list: ^DrawList, vert_start_idx: i32, vert_end_idx: i32, pivot_in: Vec2, cos_a: f32, sin_a: f32, pivot_out: Vec2)    ---
	// Garbage collection
	...
	@(link_name="ImGui_DemoMarker") DemoMarker :: proc(file: cstring, line: i32, section: cstring) ---
	// Debug Tools
	@(link_name="ImGui_DebugAllocHook")                         DebugAllocHook                               :: proc(info: ^DebugAllocInfo, frame_count: i32, ptr: rawptr, size: uint)                                                                                    --- // size >= 0 : alloc, size = -1 : free
	...
	@(link_name="ImGui_DebugNodeFontGlyphsForSrcMask")          DebugNodeFontGlyphsForSrcMask                :: proc(font: ^Font, baked: ^FontBaked, src_mask: i32)                                                                                                       ---
	@(link_name="ImGui_DebugNodeFontGlyph")                     DebugNodeFontGlyph                           :: proc(font: ^Font, glyph: ^FontGlyph)                                                                                                                      ---
	@(link_name="ImGui_DebugNodeTexture")                       DebugNodeTexture                             :: proc(tex: ^TextureData, int_id: i32, highlight_rect: ^FontAtlasRect = nil)                                                                                --- // ID used to facilitate persisting the "current" texture.
	...
	@(link_name="ImGui_DebugNodeWindowsListByBeginStackParent") DebugNodeWindowsListByBeginStackParent       :: proc(windows: ^^Window, windows_size: i32, parent_in_begin_stack: ^Window)                                                                                ---
	@(link_name="ImGui_DebugNodeViewport")                      DebugNodeViewport                            :: proc(viewport: ^ViewportP)                                                                                                                                ---
	@(link_name="ImGui_DebugNodePlatformMonitor")               DebugNodePlatformMonitor                     :: proc(monitor: ^PlatformMonitor, label: cstring, idx: i32)                                                                                                 ---
	...
	@(link_name="cImFontAtlasRectId_GetIndex")                  cImFontAtlasRectId_GetIndex                  :: proc(id: FontAtlasRectId) -> i32                                                                                                                          ---
	@(link_name="cImFontAtlasRectId_GetGeneration")             cImFontAtlasRectId_GetGeneration             :: proc(id: FontAtlasRectId) -> u32                                                                                                                          ---
	@(link_name="cImFontAtlasRectId_Make")                      cImFontAtlasRectId_Make                      :: proc(index_idx: i32, gen_idx: i32) -> FontAtlasRectId                                                                                                     ---
	...
	@(link_name="cImFontAtlasBuildRenderBitmapFromString")      cImFontAtlasBuildRenderBitmapFromString      :: proc(atlas: ^FontAtlas, x: i32, y: i32, w: i32, h: i32, in_str: cstring, in_marker_char: u8)                                                              ---
	@(link_name="cImFontAtlasBuildClear")                       cImFontAtlasBuildClear                       :: proc(atlas: ^FontAtlas)                                                                                                                                   --- // Clear output and custom rects
	@(link_name="cImFontAtlasTextureAdd")                       cImFontAtlasTextureAdd                       :: proc(atlas: ^FontAtlas, w: i32, h: i32) -> ^TextureData                                                                                                   ---
	@(link_name="cImFontAtlasTextureMakeSpace")                 cImFontAtlasTextureMakeSpace                 :: proc(atlas: ^FontAtlas)                                                                                                                                   ---
	@(link_name="cImFontAtlasTextureRepack")                    cImFontAtlasTextureRepack                    :: proc(atlas: ^FontAtlas, w: i32, h: i32)                                                                                                                   ---
	@(link_name="cImFontAtlasTextureGrow")                      cImFontAtlasTextureGrow                      :: proc(atlas: ^FontAtlas, old_w: i32 = -1, old_h: i32 = -1)                                                                                                 ---
	...
	@(link_name="cImFontAtlasBuildGetOversampleFactors")        cImFontAtlasBuildGetOversampleFactors        :: proc(src: ^FontConfig, baked: ^FontBaked, out_oversample_h: ^i32, out_oversample_v: ^i32)                                                                 ---
	@(link_name="cImFontAtlasBuildDiscardBakes")                cImFontAtlasBuildDiscardBakes                :: proc(atlas: ^FontAtlas, unused_frames: i32)                                                                                                               ---
	...
	@(link_name="cImFontAtlasFontDiscardBakes")                 cImFontAtlasFontDiscardBakes                 :: proc(atlas: ^FontAtlas, font: ^Font, unused_frames: i32)                                                                                                  ---
	...
	@(link_name="cImFontAtlasBakedSetFontGlyphBitmap")          cImFontAtlasBakedSetFontGlyphBitmap          :: proc(atlas: ^FontAtlas, baked: ^FontBaked, src: ^FontConfig, glyph: ^FontGlyph, r: ^TextureRect, src_pixels: ^u8, src_fmt: TextureFormat, src_pitch: i32) ---
	@(link_name="cImFontAtlasPackInit")                         cImFontAtlasPackInit                         :: proc(atlas: ^FontAtlas)                                                                                                                                   ---
	@(link_name="cImFontAtlasPackAddRect")                      cImFontAtlasPackAddRect                      :: proc(atlas: ^FontAtlas, w: i32, h: i32, overwrite_entry: ^FontAtlasRectEntry = nil) -> FontAtlasRectId                                                    ---
	...
	@(link_name="cImFontAtlasUpdateNewFrame")                   cImFontAtlasUpdateNewFrame                   :: proc(atlas: ^FontAtlas, frame_count: i32, renderer_has_textures: bool)                                                                                    ---
	...
	@(link_name="cImFontAtlasTextureBlockConvert")              cImFontAtlasTextureBlockConvert              :: proc(src_pixels: ^u8, src_fmt: TextureFormat, src_pitch: i32, dst_pixels: ^u8, dst_fmt: TextureFormat, dst_pitch: i32, w: i32, h: i32)                    ---
	...
	@(link_name="cImFontAtlasTextureBlockFill")                 cImFontAtlasTextureBlockFill                 :: proc(dst_tex: ^TextureData, dst_x: i32, dst_y: i32, w: i32, h: i32, col: u32)                                                                             ---
	@(link_name="cImFontAtlasTextureBlockCopy")                 cImFontAtlasTextureBlockCopy                 :: proc(src_tex: ^TextureData, src_x: i32, src_y: i32, dst_tex: ^TextureData, dst_x: i32, dst_y: i32, w: i32, h: i32)                                        ---
	@(link_name="cImFontAtlasTextureBlockQueueUpload")          cImFontAtlasTextureBlockQueueUpload          :: proc(atlas: ^FontAtlas, tex: ^TextureData, x: i32, y: i32, w: i32, h: i32)                                                                                ---
	@(link_name="cImTextureDataQueueUpload")                    cImTextureDataQueueUpload                    :: proc(tex: ^TextureData, x: i32, y: i32, w: i32, h: i32)                                                                                                   ---
	@(link_name="cImTextureDataGetFormatBytesPerPixel")         cImTextureDataGetFormatBytesPerPixel         :: proc(format: TextureFormat) -> i32                                                                                                                        ---
...
DemoMarkerCallback  :: proc "c" (file: cstring, line: i32, section: cstring)
