...
OUTPUT_GETNUMDRIVERS_CALLBACK :: #type proc "c" (
...
OUTPUT_OBJECT3DGETINFO_CALLBACK :: #type proc "c" (
    output_state: ^OUTPUT_STATE,
    maxhardwareobjects: ^i32,
) -> RESULT

OUTPUT_OBJECT3DALLOC_CALLBACK :: #type proc "c" (
    output_state: ^OUTPUT_STATE,
    object3d: ^rawptr,
) -> RESULT

OUTPUT_OBJECT3DFREE_CALLBACK :: #type proc "c" (
    output_state: ^OUTPUT_STATE,
    object3d: rawptr,
) -> RESULT
...
OUTPUT_READFROMMIXER_FUNC :: #type proc "c" (
    output_state: ^OUTPUT_STATE,
    buffer: rawptr,
    length: u32,
) -> RESULT
