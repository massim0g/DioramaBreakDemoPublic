...
foreign lib {
	...
	RenderGeometryRaw			 :: proc(renderer: ^Renderer, texture: ^Texture, xy: [^]f32, xy_stride: c.int, colors: [^]Color, color_stride: c.int, uv: [^]f32, uv_stride: c.int, num_vertices: c.int, indices: rawptr, num_indices: c.int, size_indices: c.int) -> c.int ---
}
