...
SOUND_PCMSETPOS_CALLBACK :: #type proc "c" (
    sound: ^SOUND,
    subsound: i32,
    position: u32,
    postype: TIMEUNIT,
...
FILE_OPEN_CALLBACK :: #type proc "c" (
    name: cstring,
    filesize: ^u32,
    handle: ^rawptr,
    userdata: rawptr,
...
MEMORY_ALLOC_CALLBACK :: #type proc "c" (size: u32, _type: MEMORY_TYPE, sourcestr: cstring)

MEMORY_REALLOC_CALLBACK :: #type proc "c" (
    ptr: rawptr,
    size: u32,
    _type: MEMORY_TYPE,
    sourcestr: cstring,
...
MEMORY_FREE_CALLBACK :: #type proc "c" (ptr: rawptr, _type: MEMORY_TYPE, sourcestr: cstring)
