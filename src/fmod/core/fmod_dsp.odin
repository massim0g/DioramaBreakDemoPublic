...
DSP_SETPARAM_DATA_CALLBACK :: #type proc "c" (
    dsp_state: ^DSP_STATE,
    index: i32,
    data: rawptr,
    length: u32,
...
DSP_GETPARAM_INT_CALLBACK :: #type proc "c" (
    dsp_state: ^DSP_STATE,
    index: i32,
    value: ^i32,
    valuestr: [^]u8,
...
DSP_GETPARAM_BOOL_CALLBACK :: #type proc "c" (
    dsp_state: ^DSP_STATE,
    index: i32,
    value: b32,
    valuestr: [^]u8,
