...
#assert(size_of(SDLEvent) == size_of(SDLEvent{}.padding))
...
EventFilter :: proc "c" (userdata: rawptr, event: ^SDLEvent) -> c.int
...
foreign lib {
	PumpEvents       :: proc() ---
	PeepEvents       :: proc(events: [^]SDLEvent, numevents: c.int, action: eventaction, minType, maxType: EventType) -> c.int ---
	...
	PollEvent        :: proc(event: ^SDLEvent) -> bool ---                 // original return value is c.int
	WaitEvent        :: proc(event: ^SDLEvent) -> bool ---                 // original return value is c.int
	WaitEventTimeout :: proc(event: ^SDLEvent, timeout: c.int) -> bool --- // original return value is c.int
	PushEvent        :: proc(event: ^SDLEvent) -> bool ---                 // original return value is c.int
